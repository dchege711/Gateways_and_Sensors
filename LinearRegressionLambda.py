...
def main():
	...
	item_S = table_S.getItem({'forum' : '1', 'subject' : 'PC1'})
	...
	datanum = int(item_S['sampleSize']) * 2
	...
	item_A = table_A.getItem({'forum' : 'roomA', 'subject' : 'sensorA'})
	...
	item_B = table_B.getItem({'forum' : 'roomA', 'subject' : 'sensorB'})
	...
	item_C = table_C.getItem({'forum' : 'roomA', 'subject' : 'sensorC'})
	aggregatedData = item_C['aggregated_data']
	datanum = len(aggregatedData)
	# print("DataNum : ", datanum, "Available : ", len(aggregatedData))
	...
	print("Max bluetooth latency : ", Comm_pi_pi)
	...
	print("Max upload latency : ", Comm_pi_lambda)
	...
	print("Max computational latency : ", Compu_pi)
	...
	item = table.addItem(lambdaResults)
